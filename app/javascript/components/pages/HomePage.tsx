...
import Payments from "@components/pages/PaymentsPage";
...
const HomePage = () => {
    ...
    const handleClickLogOut = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li onClick={() => navigate('/Payments')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg
                                    aria-hidden="true"
                                    className="mx-auto mb-1 w-7 h-7 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-gray-400"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                        ...
                        <li onClick={() => navigate('/Rentals')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Rentals</span>
                            </a>
                        </li>

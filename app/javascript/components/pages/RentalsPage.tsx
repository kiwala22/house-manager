        ...
        <div className="block p-6 rounded-lg bg-gray-100 dark:bg-gray-800">
          <div className="relative overflow-hidden sm:rounded-lg">
            <div className="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
              <div>
                <h5 className="mr-3 font-semibold dark:text-white">Rentals</h5>
                <p className="text-gray-500 dark:text-gray-400">Manage all your existing rentals or add a new one</p>
              </div>
              <div>

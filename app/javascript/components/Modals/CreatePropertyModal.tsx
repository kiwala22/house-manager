...
const CreateRoom: React.FC<CreatePropertyModalProps> = ({ addProperty }) => {
  ...
  return (
    <>
      ...
      <button type="button"
        onClick={toggleModal}
        className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 transition duration-150 ease-in-out dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-700">
        Add property
      </button>
